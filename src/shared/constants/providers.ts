...
export const OAUTH_PROVIDERS = {
  ...
  "gitlab-duo": {
    ...
    authHint:
      "OAuth application with ai_features + read_user + read_api scopes. Configure GITLAB_DUO_OAUTH_CLIENT_ID and optionally GITLAB_DUO_OAUTH_CLIENT_SECRET on this OmniRoute instance.",
  },
  cursor: {
    id: "cursor",
    alias: "cu",
